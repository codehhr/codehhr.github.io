  ...
  return (function (t) {
    ...
    function (t, e, o) {
          ...
          var t = (function () {
              ...
              if (r.rangeCount) {
                var i = r.getRangeAt(0),
                  a = i.startContainer;
                return (
                  a.nodeType === document.TEXT_NODE && (a = a.parentNode),
                  {
            ...
            e = 5 + Math.round(10 * Math.random());
          e--;

        )
          (i[a] = u(t.x, t.y, t.color)), (a = (a + 1) % 500);
        if (p.shake) {
          var n = 1 + 2 * Math.random(),
            r = n * (Math.random() > 0.5 ? -1 : 1),
            l = n * (Math.random() > 0.5 ? -1 : 1);
      ...
      function f() {
        ...
        for (
          var t = !1, e = n.getBoundingClientRect(), o = 0;
          o < i.length;
          ++o
        ) {
          var a = i[o];
          a.alpha <= 0.1 ||
            ...
            (r.fillStyle = a.color),
            r.fillRect(
              Math.round(a.x - 1.5) - e.left,
              Math.round(a.y - 1.5) - e.top,
              3,
              3
            ),
            (t = !0));
      ...
      !(function () {
        ...
        function n(t, n, r) {
          ...
          (l.whiteSpace = "pre-wrap"),
            ...
            o
              ? t.scrollHeight > parseInt(c.height) && (l.overflowY = "scroll")
              : (l.overflow = "hidden"),
            (d.textContent = t.value.substring(0, n)),
            "INPUT" === t.nodeName &&
              (d.textContent = d.textContent.replace(/\s/g, " "));
